...
class ParentWindow(Frame):
    def __init__(self, master):
        ...
        self.lblFName = Entry(self.master,text=self.varFName, font=("Helvetica", 16), fg='black', bg='lightblue' )
        self.lblFName.grid(row=0, column=1,padx=(30,0), pady=(30,0))

        self.lblLName = Entry(self.master,text=self.varLName, font=("Helvetica", 16), fg='black', bg='lightblue' )
        self.lblLName.grid(row=1, column=1, padx=(30,0), pady=(30,0))
